                    ...
                    if (product.numberOrdered > 0)
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            "Hot",
                            style: AppTextStyles.cap8.copyWith(color: Colors.white),
                          ),
                        ),
                      ),
                    Positioned(
                        ...
                        child: RichText(
                          ...
                          text: TextSpan(
                            children: [
                              TextSpan(
                                text: "Từ: ",
                                style: AppTextStyles.cap10.copyWith(color: AppColors.primary500),
                              ),
                              TextSpan(
                                text: "${CurrencyUtils.formatVNDWithoutSymbol(product.price)}đ",
                                style: AppTextStyles.label12.copyWith(color: AppColors.primary500),
                              ),
                            ],
                          ),
                        ),
