...
class UpdateAddressPage extends GetView<UpdateAddressController> {
  ...
  static void navigateTo(int addressId) {
    Get.toNamed(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        // Show loading indicator while loading address data
        if (controller.isLoading.value && controller.editingAddress == null) {
        ...
        if (controller.editingAddress != null) {
                          ...
                          () => InputLabel(
                            ...
                            child: FormBuilderDropdown<String>(
                              ...
                              initialValue: controller.selectedProvinceCode.value ??
                                  (controller.editingAddress?.province?.provinceCode),
                              decoration: InputDecoration(
                    ...
                    () => controller.selectedProvinceCode.value == null
                        ...
                        : Obx(
                            () => InputLabel(
                              ...
                              child: FormBuilderDropdown<String>(
                                name: 'ward_code',
                                initialValue: controller.selectedWardCode.value ??
                                    (controller.editingAddress?.ward?.wardCode),
                                decoration: InputDecoration(
              ...
              Expanded(
                ...
                child: Obx(
                  () => ElevatedButton(
                    ...
                    child: Text(
                      controller.isLoading.value ? 'Đang xử lý...' : 'Lưu thay đổi',
